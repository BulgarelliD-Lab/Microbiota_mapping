...
#import data picked wiht JH07 DADA2
...
summarize_phyloseq(JH07_data_phyloseq_sample)
...
#import data picked wiht JH15 DADA2
...
summarize_phyloseq(JH15_data_phyloseq_sample)
...
#the key question: how to integrate the tecnical reproducibility into the total counts. 
