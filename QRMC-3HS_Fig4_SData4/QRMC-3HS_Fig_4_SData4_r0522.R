...
input.folder <- 'salmon'
quant.folder <- 'quants'
#path("/cluster/db/R_shared/3H_manuscript/") 
...
#for the reproducibility of the code in absence of counts folders load genes_dge.RData
...
#upload gene annotation: this file is available here https://ics.hutton.ac.uk/barleyrtd/bart_v2_18.html
