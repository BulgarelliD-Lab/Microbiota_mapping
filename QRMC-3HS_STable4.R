...
Root_arq_CE3 <- read.delim("ROOT_ARCH_CE_3_Entire_root.txt", sep = "\t", stringsAsFactors = TRUE) 
...
shapiro.test(Root_arq_CE3$Shoot_weight)

qqnorm (Root_arq_CE3$Shoot_weight) + qqline(Root_arq_CE3$Shoot_weight)
hist(Root_arq_CE3$Shoot_weight)
...
shapiro.test(Root_arq_CE3$Root_weight)

qqnorm (Root_arq_CE3$Root_weight) + qqline(Root_arq_CE3$Root_weight)
hist(Root_arq_CE3$Root_weight)

kruskal.test(Root_weight~Genotype , data=Root_arq_CE3)
...
qqnorm (Root_arq_CE3$SurfArea) + qqline(Root_arq_CE3$SurfArea)
...
qqnorm (Root_arq_CE3$AvgDiam ) + qqline(Root_arq_CE3$AvgDiam )
...
qqnorm (Root_arq_CE3$RootVol) + qqline(Root_arq_CE3$RootVol)
...
qqnorm (Root_arq_CE3$Tips) + qqline(Root_arq_CE3$Tips)
...
qqnorm (Root_arq_CE3$Forks) + qqline(Root_arq_CE3$Forks)
...
qqnorm (Root_arq_CE3$RootDen) + qqline(Root_arq_CE3$RootDen)
