...
#import data picked wiht  JH23 DADA2
...
#From 973 taxa, we have lost 274 ASvs
...
#########################################################################
# Inport a simplified mapping file
########################################################################
...
p=plot_ordination(JH23_rare_sqrt, JH23_rhizosphere_CAP , color = "Genotype", shape="Genotype")
p = p + geom_point(size = 6, alpha = 0.80, stroke =2)
p = p + scale_colour_manual(values = c("#D55E00","#D55E00", "#0072B2"))
p= p+scale_shape_manual(values=c('Barke'=17, '19'=17, '56'=2))
