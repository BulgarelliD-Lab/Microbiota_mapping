...
################################################################################################
#Supplementary figure 3 Top 5 phylums of differentilly enriched taxa between the parental lines
###############################################################################################
...
#Merge the two phyloseq objects with differentail enriched (DE) between the parental lines
DE_parentals_parentals_rhizo<-merge_phyloseq(JH07_plants_HID144,JH07_plants_Barke)
DE_parentals_parentals_rhizo_2<-subset_samples(DE_parentals_parentals_rhizo, Description != "BC1S3")
