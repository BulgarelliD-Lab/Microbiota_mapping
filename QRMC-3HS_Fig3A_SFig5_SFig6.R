...
#  Figure 3A, Supplementary Fig.6AD,  Supplementary Fig. 5 qPCR
#  Revision 09/21 
...
#disclaimer to iddentify OTU enriched in B124.52 vs B.124.17
########################################################################
...
#identify the ones diffentially enriched between Barke and Bulk soil
###########################################################################################
...
#identify the ones diffentially enriched between B.124.17 and Bulk soil
################################################################################
#define the OTUs significantly enriched in the rhizosphere samples
...
#identify the ones diffentially enriched between Barke and B124.HID2_52
###############################################################################
#define the OTUs significantly enriched in the rhizosphere samples
...
JH15_dada2_tax_table[B124.52_a_enriched_FDR005_vs_Barke_rhizo, ]
...
#######################################################################
#######################################################################
#Supplementary_figure 6 Alpha diversity calculations 
#######################################################################
#######################################################################
...
############################################################
############################################################
###Supplementary figure 5: 16S and ITS DNA copies
############################################################
#########################################################
...
qJH23 <-(read.delim("JH15_quantification_copy_numbers.txt", sep = "\t"))
